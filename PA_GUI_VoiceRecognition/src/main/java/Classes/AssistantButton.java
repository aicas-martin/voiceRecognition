...
public class AssistantButton  {
    ...
    public static void recognizerDialog(LiveSpeechRecognizer recognizer) {
   ...
   public static void main(String[] args) throws Exception {
        ...
        while (true) {
        	System.out.println("_____________________________________________________________ ");
    		System.out.println("                                                              ");
    		System.out.println("               AssistantButton Menu                   		  ");
    		System.out.println("_____________________________________________________________ ");
    		System.out.println("                                                              ");
    		System.out.println("               Option 1: Digit                     			  ");
    		System.out.println("               Option 2: Dialog                       		  ");
    		System.out.println("               Option 3: Bank                                 ");
    		System.out.println("               Option 4: Back                                 ");
    		System.out.println("                                                              ");
    		System.out.println("_____________________________________________________________ ");
    		System.out.println("                                                              ");
            ...
            if (utterance.endsWith("dialog")) {
                jsgfRecognizer.stopRecognition();
                recognizerDialog(lmRecognizer);
                DialogDemo.main(args);
                jsgfRecognizer.startRecognition(true);
            }
        }
